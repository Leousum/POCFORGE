...
class Assign():
    def __init__(self) -> None:
        self.node_type = StmtType.ASSIGNMENT
        self.cpg_id = None
        self.code = None
...
class ObjCall():
    def __init__(self) -> None:
        self.node_type = StmtType.OBJECT_CALL
        self.cpg_id = None
        self.code = None
        self.fullName = None
        self.obj = None
...
class CommonCall():
    def __init__(self) -> None:
        self.node_type = StmtType.COMMON_CALL
        self.cpg_id = None
        self.code = None
        self.fullName = None
        self.method = None
...
class Method():
    def __init__(self) -> None:
        ...
        self.shortName = None # e.g. find_min
    ...
    def to_string(self, level = -1):
        ...
        content += "\n" + (f"{prefix}| fullName: {self.fullName}")
        content += "\n" + (f"{prefix}| shortName: {self.shortName}")
...
class MethodReturn():
    def __init__(self) -> None:
        self.node_type = StmtType.METHOD_RETURN
        self.cpg_id = None
        self.code = None
